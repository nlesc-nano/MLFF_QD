...
from pytorch_lightning.loggers import CSVLogger  # new line added
...
def setup_task_and_trainer(config, nnpot, outputs, folder):
    ...
    csv_logger = CSVLogger(save_dir=folder, name="csv_logs", version="") # new line added
    ...
    trainer = pl.Trainer(
        callbacks=callbacks,
        logger=[tensorboard_logger, csv_logger], # new line added
